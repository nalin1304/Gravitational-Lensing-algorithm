...
def main():
    ...
    with tab5:
        ...
        modules_to_check = [
            ("Core Lensing", "gravitational_lensing_toolkit.lens_models"),
            ("PINN", "gravitational_lensing_toolkit.ml.pinn"),
            ("Validation", "gravitational_lensing_toolkit.validation"),
            ("Uncertainty", "gravitational_lensing_toolkit.ml.uncertainty"),
            ("Multi-Plane", "gravitational_lensing_toolkit.lens_models.multi_plane"),
            ("Real Data", "gravitational_lensing_toolkit.data.real_data_loader")
        ]
