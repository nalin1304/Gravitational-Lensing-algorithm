...
def main():
    ...
    if not MODULES_AVAILABLE:
        show_warning("Validation modules partially available. Some features may be limited.")
    ...
    with col_pred3:
        pred_einstein_r = st.number_input(
            ...
            min_value=0.1,
            max_value=100.0,
            value=system_info['einstein_radius'],
            format="%.2f",
