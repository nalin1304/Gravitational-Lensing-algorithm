# Streamlit Web Application# Gravitational Lensing Analysis Web App



**📖 For complete documentation, see [PROJECT_DOCUMENTATION.md](../PROJECT_DOCUMENTATION.md)**Professional Streamlit web application for gravitational lensing analysis, convergence map generation, and PINN-based inference.



Multi-page Streamlit application for gravitational lensing analysis.## Features



## 🚀 Quick Launch### 🏠 Home Page

- Project overview with key metrics

```powershell- Feature highlights

# NEW multi-page structure (as of Nov 5, 2025)- Quick start guide

streamlit run app/Home.py- System information

```

### 🎲 Generate Synthetic Data

**Access at**: http://localhost:8501- Real-time NFW and Elliptical NFW convergence maps

- Interactive parameter controls:

## 📁 Structure  - Mass: 10¹¹ - 10¹⁴ M☉

  - Scale radius: 50-500 kpc

```  - Ellipticity: 0.0-0.5

app/  - Grid size: 32/64/128

├── Home.py                    # Main entry point- Download generated data as NumPy .npy files

├── pages/                     # Multi-page structure

│   ├── 02_Simple_Lensing.py### 📊 Analyze Real Data

│   ├── 03_PINN_Inference.py- Upload FITS observations

│   ├── 04_Multi_Plane.py- Display metadata (shape, pixel scale, coordinates)

│   ├── 05_Real_Data.py- Preprocessing controls (resize, normalize, NaN handling)

│   ├── 06_Training.py- Before/after visualization

│   ├── 07_Validation.py

│   ├── 08_Bayesian_UQ.py### 🧠 Model Inference

│   └── 09_Settings.py- Load pretrained PINN models

└── utils/                     # Shared utilities- Predict halo parameters (M_vir, r_s, ellipticity)

    ├── session_state.py- Classification with confidence scores
...
## 📖 Full Documentation- Parameter uncertainty (mean, std, 95% CI)

- Predictive entropy

See [PROJECT_DOCUMENTATION.md](../PROJECT_DOCUMENTATION.md) for:- Confidence interval visualization

- Complete installation guide

- All features and capabilities### ℹ️ About

- Security implementation- Project documentation

- Troubleshooting- References and citations

- ISEF presentation guide- Technical details
...
**Version**: 1.0.0 | **Status**: Production Ready | **Security**: 95/100### Prerequisites
...
```powershell
# From project root (NEW Multi-Page Structure)
