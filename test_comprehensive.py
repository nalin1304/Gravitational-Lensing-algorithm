...
def test_geodesic_integration():
    ...
    try:
        from optics.geodesic_integration import GeodesicIntegrator
...
def test_psf_models():
    ...
    try:
        from data.real_data_loader import PSFModel
...
def test_multiplane_lensing():
    ...
    try:
        from lens_models.multi_plane import MultiPlaneLens
...
def test_hst_validation():
    ...
    try:
        from validation.hst_targets import HSTValidation
...
def test_substructure():
    ...
    try:
        from dark_matter.substructure import SubhaloPopulation, SubstructureDetector
